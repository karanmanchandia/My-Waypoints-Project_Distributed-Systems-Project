...
address="";
   ...
   data.send(null);
    ...
    var url2 = "http://api.openweathermap.org/data/2.5/weather?q="+endd+"&units=imperial&appid=d6f3cfaff318f1cdbd19b7bde0259f64";
...
//check if directions exist in database
var datacheck="start="+start+"&end="+end;
...
$.ajax({
              ...
              success:function(dat){
                if(dat!=2){
                  ...
                  document.getElementById('right-panel').append("<p>"+dat+"</p>");
          ...
          if (status === 'OK') {
            ...
            var directions=document.getElementById('right-panel').innerHTML;
            var data="source="+start+"&destination="+end+"&directions="+directions;
            var urll="update.php";
            $.ajax({
              type:"POST",
              data:data,
